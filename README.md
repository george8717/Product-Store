...
Highlights:
 ...
 c)Designed responsive UI using Chakra UI components with dynamic interactions.
 
 d)Integrated backend API with Express.js and MongoDB for data persistence.
 
 e)Ensured seamless user experience with real-time updates and error handling.
